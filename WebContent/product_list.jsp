...
<body>
    ...
    <section id="main">
        <div class="container_12">
			...
			<a href="list_Product.do?index=1&fid=${fid}&cid=${cid}&mid=${mid}" style="font-family:楷体;">首页</a>&nbsp;&nbsp;
			</li>
			...
			<c:choose>
            <c:when test="${index >1}">
            <a href="list_Product.do?index=${index-1}&fid=${fid}&cid=${cid}&mid=${mid}" style="font-family:楷体;">上一页</a>
            </c:when>
            <c:otherwise>
            ...
            <a href="list_Product.do?index=${index+1}&fid=${fid}&cid=${cid}&mid=${mid}" style="font-family:楷体;">下一页</a>
            </c:when>
            <c:otherwise>
			...
			<li >
			<a href="list_Product.do?index=${pages}&fid=${fid}&cid=${cid}&mid=${mid}" style="font-family:楷体;">末页</a>
			</li>
		    </ul>
                </div><!-- .pagination -->
