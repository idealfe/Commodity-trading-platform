        ...
        <div class="container_12">
			...
			<div class="entry_content">
				...
				<div class="availability_sku">
					...
					商品类别: <font style="color:#6F8921">${product.fcategory.name}/${product.ccategory.name}/${product.mcategory.name}</font>
				    </div>
				    <div class="availability" style="margin-top: 10px;">
					发布时间: <font style="color:#6F8921">${product.savetime}</font>
				    </div>
				    <div class="availability" style="margin-top: 10px;">
					发布者: <font style="color:#6F8921">${product.seller.uname}</font>
				    </div>
			    ...
			    <div class="cart">
                                ...
                                <a href="javascript:addTousu('${product.id}')" class="bay" style="background: #6F8921">投诉</a>
                </div><!-- .cart -->
			...
			<div id="wrapper_tab" class="tab1">
				...
				<h4>用户评论</h4>
                   ...
                   <c:forEach items="${commentlist}" var="comment">
					...
					<p>${comment.content }</p>
					<c:if test="${comment.replycontent ne '' and comment.replycontent ne null}">
					<p>[卖家回复:]&nbsp;&nbsp;${comment.replycontent}</p>
                     </c:if>
                     </li>
					</c:forEach>
                   ...
                   <input type="hidden" value="${product.id}" name="productid">
					...
					<div class="evaluation">
					    <div class="grid_3">
							...
							<select name="quality" style="border:0px;height: 30px;">
						...
						<div class="grid_3" >
							<strong>价格</strong><br>
							<select name="price" style="border:0px;height: 30px;">
							    <option value="5">&nbsp;&nbsp;&nbsp;&nbsp;5&nbsp;&nbsp;&nbsp;&nbsp;</option>
							    <option value="4">&nbsp;&nbsp;&nbsp;&nbsp;4&nbsp;&nbsp;&nbsp;&nbsp;</option>
							    <option value="3">&nbsp;&nbsp;&nbsp;&nbsp;3&nbsp;&nbsp;&nbsp;&nbsp;</option>
							    <option value="2">&nbsp;&nbsp;&nbsp;&nbsp;2&nbsp;&nbsp;&nbsp;&nbsp;</option>
...
function addTousu(id){
	location.replace("tousuadd.jsp?productid="+id);
}
