                    ...
                    <table class="cart_product">
                        ...
                        <tr>
                            <td colspan="7" class="cart_but">
                                ...
                                <a href="carDel.do" class="update" style="background: #EB6447;color:white;width: 100px;height: 30px;line-height: 30px;letter-spacing: 2px;border-radius:20px 20px;font-family: '微软雅黑';font-weight: bold;">清空购物车</a>
                            </td>
                        </tr>
                    </table>
                        ...
                        <div class="grid_4" style="float: right;">
                            <div class="bottom_block total">
                                ...
                                <c:choose>
                                  ...
                                  <c:otherwise>
                                    <button class="checkout" onclick="javascript:location.replace('index.do')">快去选购商品吧 <img src="img/checkout.png" alt="" title=""></button>
                                  </c:otherwise>
                                </c:choose>
                            </div><!-- .total -->
                        </div><!-- .grid_4 -->
