...
<section class="layui-larry-box">
	<div class="larry-personal">
		...
		<div class="layui-inline" style="border:0px solid red;width: 780px;">
			<form class="layui-form" action="<%=path %>/member/inventoryList.do" method="post" id="searchform" name="searchform" style="padding-top:0px;">
		...
		-->
                ...
                <div class="layui-form news_list" >
                    ...
                    <td align="center" style="font-weight: bold;font-family:楷体;font-weight: bold; color:blue" colspan="10">
                                                                 共${total}条记录&nbsp;&nbsp;&nbsp;&nbsp;
                        <a href="inventoryList.do?index=1&key=${key}&fid=${fid}&cid=${cid}&mid=${mid}" style="font-family:楷体;">首页</a>&nbsp;&nbsp;
                        
                        <c:choose>
                        <c:when test="${index >1}">
                        <a href="inventoryList.do?index=${index-1}&key=${key}&fid=${fid}&cid=${cid}&mid=${mid}" style="font-family:楷体;">上一页</a>
                        </c:when>
                        <c:otherwise>
                        ...
                        <a href="inventoryList.do?index=${index+1}&key=${key}&fid=${fid}&cid=${cid}&mid=${mid}" style="font-family:楷体;">下一页</a>
                        </c:when>
                        <c:otherwise>
                        ...
                        &nbsp;&nbsp;
                        <a href="inventoryList.do?index=${pages}&key=${key}&fid=${fid}&cid=${cid}&mid=${mid}" style="font-family:楷体;">末页</a>
                    </td>
                  </tr>
					</tbody>
					</table>
