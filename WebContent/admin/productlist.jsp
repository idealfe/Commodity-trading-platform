...
<section class="layui-larry-box">
	<div class="larry-personal">
		...
		<div class="layui-inline" style="border:0px solid red;width: 780px;">
			<form class="layui-form" action="<%=path %>/admin/productList.do" method="post" id="searchform" name="searchform" style="padding-top:0px;">
					   ...
					   <c:forEach items="${list}" var="product" varStatus="status">
						<tr >
							...
							<td>
							  ...
							  <c:if test="${product.shstatus eq '待审核'}">
							  <a class="layui-btn layui-btn-mini" href="updateShstatus.do?id=${product.id}"><i class="iconfont icon-caozuo"></i> 通过审核</a>
							  </c:if>
