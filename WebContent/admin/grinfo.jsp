...
<section class="layui-larry-box">
	<div class="larry-personal">
		...
		<div class="larry-personal-body clearfix changepwd">
			<form class="layui-form col-lg-4" id="userform" method="post" action="<%=path %>/admin/updateGrinfo.do">
			<input type="hidden" name="id" value="${user.id}">
			 	<div class="layui-form-item">
					<label class="layui-form-label">用户名</label>
					<div class="layui-input-block">  
					  	<input type="text" name="username" id="username" value="${user.username}" disabled="disabled"  required oninvalid="setCustomValidity('用户名不能为空')" oninput="setCustomValidity('');"  readonly="readonly" style="width: 300px;"  autocomplete="off"  class="layui-input" placeholder="用户名" >
					</div>
				</div>
				...
				<div class="layui-form-item" style="width: 800px;border:0px solid red ">
					<label class="layui-form-label">性别</label>
					<div class="layui-input-inline" style="width: 300px;border:0px solid red ">
